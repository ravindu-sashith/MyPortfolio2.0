      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-300 max-w-2xl mx-auto">
            Ready to discuss cybersecurity opportunities or collaborate on projects? Get in touch!
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <Card className="bg-white/10 backdrop-blur-md border-slate-700 shadow-2xl">
              <CardHeader>
                <CardTitle className="text-2xl font-bold text-white">Let's Collaborate</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-slate-300 leading-relaxed mb-6">
                  I'm always interested in new opportunities, challenging projects, and meaningful collaborations in the cybersecurity space. Whether you're looking for:
                </p>
